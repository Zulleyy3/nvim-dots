...
hi('DiagnosticError',            { fg = 'Red', ctermbg ="Black",                         ctermfg = 1 })
hi('DiagnosticWarn',             { fg = 'Orange',                       ctermfg = 3 })
hi('DiagnosticInfo',             { fg = 'LightBlue', ctermbg = "Black",                    ctermfg = 4 })
...
if vim.o.background == 'light' then
  ...
  hi('Pmenu',        { bg = 'DarkMagenta',                            ctermfg = 'White', ctermbg = 'DarkMagenta' })
  ...
  hi('Comment',      { fg = '#90f0c6',                            ctermfg = 71 })
  ...
  hi('Identifier',   { fg = '#40ffff',                            ctermfg = 51, cterm = { bold = true } })
